...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config: training_pipeline.TrainingPipelineConfig):
...
class DataTransformationConfig:
    def __init__(self, training_pipeline_config: training_pipeline.TrainingPipelineConfig):
        ...
        self.transformed_train_file_path = os.path.join(self.data_transformation_dir, training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR, training_pipeline.TRAIN_FILE_NAME.replace("csv", "npz"))
        self.transformed_test_file_path = os.path.join(self.data_transformation_dir, training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR, training_pipeline.TEST_FILE_NAME.replace("csv", "npz"))
        self.transformed_object_file_path = os.path.join(self.data_transformation_dir, training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR, training_pipeline.DATA_TRANSFORMATION_OBJECT_FILE_NAME)
